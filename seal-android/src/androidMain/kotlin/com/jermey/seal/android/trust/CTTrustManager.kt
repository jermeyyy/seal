...
/**
 * An [X509TrustManager] wrapper that adds Certificate Transparency verification
 * on top of the system's default trust validation.
 *
 * This is useful for WebViews and other non-OkHttp connections.
 *
 * **Limitation**: Only embedded SCTs are available in TrustManager context
 * (no TLS extension or OCSP SCTs).
 */
public class CTTrustManager internal constructor(
    ...
    // X509ExtendedTrustManager overrides for hostname-aware verification
    ...
    override fun checkServerTrusted(
        ...
        // Extract hostname from socket if possible
    ...
    private fun verifyCertificateTransparency(chain: List<X509Certificate>, host: String?) {
        ...
        // Only embedded SCTs are available in TrustManager context
